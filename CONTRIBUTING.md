# Welcome to Manaba Plus contributing guide <!-- omit in toc -->

Thank you for investing your time in contributing to our project! Any contribution you make will be reflected on [Manaba Plus](https://github.com/kajikentaro/manaba-plus) :sparkles:.
...
6. インストール  
   [Chrome の拡張機能設定画面](chrome://extensions/)から Developer mode を ON にし、build ディレクトリをドラックアンドドロップします。
7. Hacking.
8. 本番用ビルドを行います  
   `npm run build`  
